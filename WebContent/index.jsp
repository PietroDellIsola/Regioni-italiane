	...
	%>
		...
		<map id="Map" name="Map">
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=Val D'Aosta" 
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=Trentino"   
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=Friuli"
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=Emilia"
