	...
	<div class="mappa" style="padding-left:33.3%;padding-top:3%;">
		...
		<map id="Map" name="Map">
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=valle-d-aosta" 
				alt="Val d'Aosta" title="Val d'Aosta"
				onMouseOver="document.Italia.src='imgRegioni/Aosta.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=piemonte"  
				alt="Piemonte" title="Piemonte"
				onMouseOver="document.Italia.src='imgRegioni/Piemonte.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=lombardia"  
				alt="Lombardia" title="Lombardia"
				onMouseOver="document.Italia.src='imgRegioni/Lombardia.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=trentino-alto-adige"   
				alt="Trentino" title="Trentino"
				onMouseOver="document.Italia.src='imgRegioni/Trentino.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=veneto"
				alt="Veneto" title="Veneto"
				onMouseOver="document.Italia.src='imgRegioni/Veneto.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=friuli-venezia-giulia"
				alt="Friuli" title="Friuli"
				onMouseOver="document.Italia.src='imgRegioni/Friuli.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=liguria"
				alt="Liguria" title="Liguria"
				onMouseOver="document.Italia.src='imgRegioni/Liguria.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=emilia-romagna"
				alt="Emilia" title="Emilia"
				onMouseOver="document.Italia.src='imgRegioni/Emilia.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=toscana"
				alt="Toscana" title="Toscana"
				onMouseOver="document.Italia.src='imgRegioni/Toscana.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=marche"
				alt="Marche" title="Marche"
				onMouseOver="document.Italia.src='imgRegioni/Marche.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=umbria"
				alt="Umbria" title="Umbria"
				onMouseOver="document.Italia.src='imgRegioni/Umbria.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=lazio"
				alt="Lazio" title="Lazio"
				onMouseOver="document.Italia.src='imgRegioni/Lazio.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=abruzzo"
				alt="Abruzzo" title="Abruzzo"
				onMouseOver="document.Italia.src='imgRegioni/Abruzzo.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=molise"
				alt="Molise" title="Molise"
				onMouseOver="document.Italia.src='imgRegioni/Molise.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=campania"
				alt="Campania" title="Campania"
				onMouseOver="document.Italia.src='imgRegioni/Campania.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=puglia"
				alt="Puglia" title="Puglia"
				onMouseOver="document.Italia.src='imgRegioni/Puglia.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=basilicata"
				 alt="Basilicata" title="Basilicata"
				onMouseOver="document.Italia.src='imgRegioni/Basilicata.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=calabria"
				alt="Calabria" title="Calabria"
				onMouseOver="document.Italia.src='imgRegioni/Calabria.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=sicilia"
				alt="Sicilia" title="Sicilia"
				onMouseOver="document.Italia.src='imgRegioni/Sicilia.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
			...
			<area shape="poly"
				...
				href="<%=request.getContextPath()%>/prendiInfo?regione=sardegna"
				 alt="Sardegna" title="Sardegna"
				onMouseOver="document.Italia.src='imgRegioni/Sardegna.png';"
				onMouseOut="document.Italia.src='imgRegioni/cartina_italia.png';" />
		</map>
	</div>
